...
describe("HTTP Client", () => {
	...
	describe("nulled instance", () => {
		...
		it("provides an infinite number of responses when only one response is configured", async () => {
			const client = HttpClient.createNull({
		...
		it("configures query strings separately", async () => {
			const client = HttpClient.createNull({
		...
		it("can be configured with a list of distinct responses per endpoint", async () => {
			const client = HttpClient.createNull({
				"/endpoint": [
