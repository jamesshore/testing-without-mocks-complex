...
export class HttpServerRequest {
	...
	/**
	 * Factory method.
	 * @param nodeRequest the HTTP request provided to the HTTP server by Node.js
	 * @returns {HttpServerRequest} the instance
	 */
