...
module.exports = class HttpServer {
	...
	async startAsync(port, log, passThroughConfig, router) {
		ensure.signatureMinimum(arguments, [ Number, Log, Object, ROUTER_TYPE ]);
	...
	async #handleRequestAsync(httpRequest) {
		try {
			...
			const response = await this._router.routeAsync(httpRequest, this._config);
