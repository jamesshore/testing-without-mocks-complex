...
import { NodeIncomingHttpHeaders } from "http/http_headers.js";


export interface NodeHttpServerRequest extends EventEmitter {
	url: string,
	method: string,
...
export class HttpServerRequest {
	 ...
	 */
	static create(nodeRequest: NodeHttpServerRequest): HttpServerRequest {
	...
	constructor(private readonly _request: NodeHttpServerRequest) {
	}
	 ...
	 */
	get headers(): NodeIncomingHttpHeaders {
...
class StubbedNodeRequest extends EventEmitter implements NodeHttpServerRequest {

	public readonly url: string;
	public readonly method: string;
	public readonly headers: NodeIncomingHttpHeaders;
...
function normalizeHeaders(headers: NodeIncomingHttpHeaders): NodeIncomingHttpHeaders {
