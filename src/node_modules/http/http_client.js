...
export class HttpClient {
	...
	/**
	 * Factory method.
	 * @returns {HttpClient} the instance
	 */
	static create() {
	 ...
	 * @param [responses] an object that maps endpoints to the responses each endpoint should return
	 ...
	 * @returns {HttpClient} the nulled instance
	 */
