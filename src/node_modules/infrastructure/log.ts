...
export class Log {
  ...
  private _listener: OutputListener<LogData>;
	...
	constructor(
		...
		private readonly _defaults: LogData = {},
	) {
	 ...
	 */
	debug(data: LogData): void { this.#log(Log.DEBUG, data); }

	/**
	 * Write a log entry with the 'info' alert level.
	 * @param data the data to write.
	 */
	info(data: LogData): void { this.#log(Log.INFO, data); }

	/**
	 * Write a log entry with the 'monitor' alert level.
	 * @param data the data to write.
	 */
	monitor(data: LogData): void { this.#log(Log.MONITOR, data); }

	/**
	 * Write a log entry with the 'action' alert level.
	 * @param data the data to write.
	 */
	action(data: LogData): void { this.#log(Log.ACTION, data); }

	/**
	 * Write a log entry with the 'emergency' alert level.
	 * @param data the data to write.
	 */
	emergency(data: LogData): void { this.#log(Log.EMERGENCY, data); }
	 ...
	 */
	trackOutput(): OutputTracker<LogData> {
		return this._listener.trackOutput();
	}

	#log(alert: "debug" | "info" | "monitor" | "action" | "emergency", data: LogData): void {
...
function normalizeErrors(data: LogData): { dataToLog: LogData, dataToTrack: LogData } {
	const dataToLog: LogData = {};
	const dataToTrack: LogData = {};
