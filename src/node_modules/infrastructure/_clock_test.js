...
describe("Clock", function() {
	...
	describe("timeouts", function() {
		...
		it("resolves if promise resolves before timeout", async function() {
		...
		it("rejects if promise rejects before timeout", async function() {
			const clock = Clock.createNull();
			const timeoutFnAsync = createTimeoutFn();
		...
		it("resolves via timeout function if promise times out", async function() {
			const clock = Clock.createNull();
		...
		it("rejects via timeout function if promise times out and timeout rejects", async function() {
			const clock = Clock.createNull();
		...
		it("ignores promise rejection after timeout", async function() {
			const clock = Clock.createNull();
			const timeoutFnAsync = createTimeoutFn("timeout result");
			const promise = (async () => {
