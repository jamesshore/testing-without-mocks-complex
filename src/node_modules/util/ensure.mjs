...
import * as typeLib from "util/type.mjs";
...
export function signature(args, signature, names) {
	checkSignature(false, args, signature, names, signature);
}

export function signatureMinimum(args, signature, names) {
