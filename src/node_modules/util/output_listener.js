...
export class OutputListener {
	...
	/**
	 * Factory method.
	 * @returns {OutputListener} the instance
	 */
	static create() {
	...
	/**
	 * Create an OutputTracker that records any future data emitted to this listener. Each
	...
	/**
	 * Emit data to be recorded by an OutputTracker. Does nothing if no OutputTrackers have
	 * been created.
	 * @param data
	 */
	emit(data) {
