...
export class ConfigurableResponses {
	...
	/**
	 * Create a list of responses (by providing an array) or a single
	 * repeating response (by providing any other type).
	 ...
	 * @param name Optional; used in error messages.
	 * @returns {{[p: string]: ConfigurableResponses}}
	 */
	...
	/**
	 * Private. Use ConfigurableResponses.create() instead.
	 */
