 ...
 */
exports.runModuleAsync = function(absolutePath, { args = [], failOnStderr = true } = {}) {
	return new Promise((resolve, reject) => {
		...
		const child = exports.forkModule(absolutePath, { args });
 ...
 * @returns { stdout, stderr } data written to stdout and stderr
 */
exports.forkModule = function(absolutePath, {
	args = []
} = {}) {
	ensure.signature(arguments, [ String, [ undefined, {
		args: [ undefined, Array ],
